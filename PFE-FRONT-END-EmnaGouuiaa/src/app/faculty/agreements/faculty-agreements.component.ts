    ...
    <div class="company-page">
      <header class="page-hero">
        <div>
          ...
          <p>Suivi des conventions, detail des signatures et signature du responsable universitaire.</p>
        </div>
  ...
  signSelectedAgreement(): void {
    ...
    this.facultyPortalService.signAgreementAsResponsable(this.selectedAgreement.id).subscribe({
      next: (updatedAgreement) => {
        ...
        this.successMessage = `Convention #${updatedAgreement.id} signee cote responsable universitaire.`;
        this.isLoading = false;
      },
      error: (error) => {
