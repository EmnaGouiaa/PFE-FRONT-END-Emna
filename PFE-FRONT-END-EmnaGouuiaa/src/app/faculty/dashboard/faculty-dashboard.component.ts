  ...
  template: `
    <div class="company-page">
      <header class="page-hero dashboard-hero dashboard-top-header">
        <div>
          <div class="dashboard-kicker">Pilotage universitaire</div>
    ...
    return [
      {
        ...
        description: 'Le responsable universitaire doit encore signer ou finaliser certaines conventions.',
        route: '/responsable/documents-stage',
        tone: 'blue'
      },
      {
  ...
  get validationQueueCards(): DashboardQueueCard[] {
    return [
      ...
      },
      {
        ...
        description: 'Demandes en attente cote responsable universitaire.',
        route: '/responsable/demandes-entreprises',
        tone: 'blue'
      },
      {
  ...
  private buildRecentActivity(
    ...
    agreements.forEach((item) => {
      ...
      items.push({
        ...
        detail: `Convention signee par le responsable universitaire.`,
        route: '/responsable/documents-stage',
        tone: 'blue',
        timestamp: date.getTime(),
        dateLabel: this.formatDateLabel(date)
